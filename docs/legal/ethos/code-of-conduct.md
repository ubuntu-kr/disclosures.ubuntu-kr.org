...
우분투는 서로에게 인간애를 보여주는 것입니다. 이 단어 자체가 인간다움의 정신을 담고 있습니다.

우리는 복잡한 분야에서 새로운 아이디어를 환영하고, 매년 모든 프로세스를 개선하며, 매우 다른 요구사항, 관심사, 기술을 가진 그룹 간의 협업을 촉진할 수 있는 생산적이고 행복하며 민첩한 커뮤니티를 원합니다.

우리는 다양성에서 힘을 얻으며, 이를 강화하는 사람들의 참여를 적극적으로 환영합니다. 이 행동 강령은 다양한 그룹이 상호 이익과 즐거움을 위해 협력할 수 있도록 보장하기 위해 존재합니다. 우리는 프로젝트에 참여하는 모든 사람의 기여를 저해할 수 있는 편견에 맞서 싸울 것입니다.

이 행동 강령은 우리의 행동으로 프로젝트가 평가될 수 있는 공개적 또는 사적인 모든 상황에서 우리가 어떻게 행동해야 하는지를 규정합니다. 우리는 공식적으로든 비공식적으로든 프로젝트를 대표하거나, 프로젝트와의 관계를 주장하거나, 직접 참여하는 모든 사람이 이를 존중하기를 기대합니다.

## 우리가 지향하는 가치
### 배려하기
우리의 작업은 다른 사람들에 의해 사용될 것이며, 우리 역시 다른 사람들의 작업에 의존하게 됩니다. 우리가 내리는 모든 결정은 사용자와 동료들에게 영향을 미치므로, 결정을 내릴 때 그들을 고려해야 합니다.

### 존중하기
의견 불일치가 무례한 태도의 변명이 될 수는 없습니다. 우리는 갈등을 해결하기 위해 함께 노력하고, 선의를 가정하며, 공감하는 방식으로 행동하기 위해 최선을 다합니다. 우리는 좌절감이 개인에 대한 공격으로 이어지는 것을 용납하지 않습니다. 사람들이 불편함이나 위협을 느끼는 공동체는 생산적인 커뮤니티가 될 수 없습니다.

### 우리의 말과 행동에 책임지기
우리 모두 실수할 수 있습니다. 그러나 실수했을 때는 그에 대한 책임을 져야 합니다.
누군가가 상처를 받거나 불쾌감을 느꼈다면, 우리는 신중하고 존중하는 태도로 경청하며, 잘못을 바로잡기 위해 노력합니다.

### 협력하기
우리가 만들어내는 것은 많은 부분으로 이루어진 복잡한 전체이며, 수많은 꿈의 총합입니다. 각자의 목표와 비전을 가진 팀들 간의 협력은 필수적입니다. 전체가 부분의 합보다 더 크기 위해서는 각 부분이 전체를 이해하려는 노력을 기울여야 합니다. 협력은 중복을 줄이고 우리 작업의 품질을 향상시킵니다. 우리는 커뮤니티 안팎에서의 좋은 협력을 함께 축하합니다. 가능한 한 업스트림 프로젝트 및 자유 소프트웨어 커뮤니티의 다른 구성원들과 긴밀히 협력하여 우리의 노력을 조율합니다. 우리는 투명하게 작업하고 관심 있는 당사자들을 가능한 한 조기에 참여시키는 것을 선호합니다.

### 결단력, 명확성, 합의를 중요하게 여기기
사회적이든 기술적이든 의견 불일치는 정상적인 일이지만, 우리는 그것이 지속되고 악화되어 다른 사람들이 합의된 방향에 대해 불확실하게 만드는 것을 허용하지 않습니다. 우리는 프로젝트 참여자들이 의견 불일치를 건설적으로 해결하기를 기대합니다. 해결할 수 없을 때는, 중재하고 명확성과 방향을 제시할 수 있도록 지정된 리더가 있는 구조로 문제를 상승시킵니다.

### 확신이 서지 않을 때 도움 요청하기
이 커뮤니티에서는 누구도 완벽하기를 기대하지 않습니다. 일찍 질문하는 것은 나중에 많은 문제를 예방하므로 질문을 권장하며 적절한 포럼으로 안내될 수 있습니다. 질문을 받은 사람은 신속하고 협조적인 태도로 대응해야 합니다.

### 신중하게 물러나기
누군가가 프로젝트를 떠나거나 참여를 중단할 때, 우리는 프로젝트에 대한 지장을 최소화하는 방식으로 그렇게 해 주시길 바랍니다. 그들은 떠난다는 것을 사람들에게 알리고, 다른 사람들이 중단된 지점부터 이어갈 수 있도록 적절한 조치를 취해야 합니다.
