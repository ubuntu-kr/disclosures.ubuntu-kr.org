...
> 이 개인정보처리방침은 2023년 6월 3일 부터 적용됩니다.		
...
| --- | --- | --- | --- | --- |
| 행사 참가자 등록 및 참가자 확인 | 이름, 소속, 직업 또는 직책, 이메일 주소 | 이벤트 플랫폼(미정) | 이벤트 플랫폼을 통해 참가 등록 완료 시 | 1년 |
| 등록비 결제 관리 | 결제 내역 | 이벤트 플랫폼(미정) | 이벤트 플랫폼을 통해 참가 등록 완료 시 | 5년 |
| 마케팅 및 광고에의 활용 | 이메일 주소 | 이벤트 플랫폼(미정) | 이벤트 플랫폼을 통해 참가 등록 완료 시 | 1년 |
...
## 제15조(개인정보 처리방침 변경)		
1. 이 개인정보처리방침은 2023년 2023년 6월 3일 부터 적용됩니다.		
