...
> 이 개인정보처리방침은 2024년 6월 25일 부터 적용됩니다.		
...
| 주식회사 와탭랩스 | 서울특별시 서초구 서초대로77길 17, 13층 1303호(서초동) | support@whatap.io | 성함, 소속, 직책(또는 직업), 이메일 주소 | 마케팅 활용 | 2025년 8월 10일 까지 | 파일(전자적) 삭제 및 관련 서류(물리적) 파쇄 |
...
## 제15조(개인정보 처리방침 변경)		
1. 이 개인정보처리방침은 2024년 6월 25일 부터 적용됩니다.		
